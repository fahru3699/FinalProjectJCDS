...
- Factors of herd immunity behavior includes:
  1. Mean of daily vaccinations, vaccinations per 100 people and vaccinations per 1,000,000 people
...
- Quantitative measure that represents the factors:
  ...
  2. Vaccinations per 100 people
  3. Vaccinations per 1 mio people
  4. Status of vaccine(s) variant in each country
  5. Status of vaccine(s) being utilised based on percentage
